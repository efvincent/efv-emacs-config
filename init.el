...
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil symon dmenu diminish spaceline company rainbow-delimiters zenburn-theme hungry-delete switch-window rainbow-mode avy smex ido-vertical-mode exec-path-from-shell org-bullets beacon spacemacs-theme which-key use-package)))
(custom-set-faces
